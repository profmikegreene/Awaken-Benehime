...
<div id="globalNav" class="globalNav">
  <div id="megaDropButton" class="megaDropButton"></div>
	<div id="gNBttons" class="gNButtons"><ul id="quickLinks" class="quickLinks"> 
      <li>
        <a class="blue button" href="#" id="globalMyRCC">myRCC<span class="dropdownArrow">&#9660;</span></a>
        <div id="myRCCDropdown" class="myRCCDropdown">
            <form class="loginForm" method="POST" name="authx" action="https://rcc.my.vccs.edu/login" onsubmit="return myVCCSValidate();" id="loginForm">
              <label>Username</label>
              <input type="text" name="vccsid" id="vccsid" tabindex="-1">
              <br />
              <label>Password</label>
              <input type="password" name="password_temp" tabindex="1">
              <br />
  ...
  <div id="accessibility" class="accessibility"> 
    <div id="siteSearch" class="siteSearch">
      ...
      <form action="http://www.google.com/cse" id="cse-search-box"> 
		    ...
		    <div id="searchButton" class="blue button searchButton" >
